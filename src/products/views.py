...
# 	f = ProductFilter(request.GET, queryset=qs).qs
# 	print f
...
class FilterMixin(object):
	...
	def get_context_data(self, *args, **kwargs):
		...
		if filter_class:
			f = filter_class(self.request.GET, queryset=qs).qs
...
class ProductDetailView(DetailView):
	...
	def get_context_data(self, *args, **kwargs):
		...
		#order_by("-title")
		context["images"] = instance.get_image_set()
		context["related"] = sorted(Product.objects.get_related(instance)[:1], key= lambda x: random.random())
		context["colors"] = instance.variation_set.distinct('color')
		context["sizes"] = instance.variation_set.distinct('size')
		return context
